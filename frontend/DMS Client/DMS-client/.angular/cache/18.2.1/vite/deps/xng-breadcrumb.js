import {
  ...
  RouterLink,
  RouterModule
} from "./chunk-2KSQ4YAN.js";
import "./chunk-S5EVHLU7.js";
import "./chunk-NXRPWDFH.js";
import {
  AsyncPipe,
  CommonModule,
  NgClass,
...
_BreadcrumbItemDirective.ɵfac = function BreadcrumbItemDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BreadcrumbItemDirective)();
};
...
_BreadcrumbService.ɵfac = function BreadcrumbService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BreadcrumbService)(ɵɵinject(ActivatedRoute), ɵɵinject(Router));
};
...
_BreadcrumbComponent.ɵfac = function BreadcrumbComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BreadcrumbComponent)(ɵɵdirectiveInject(BreadcrumbService), ɵɵdirectiveInject(ActivatedRoute));
};
